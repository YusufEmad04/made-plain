...
export const ENGINES_OF_GROWTH_AR_DURATION = manifest.totalFrames + TAIL_FRAMES;
...
export const EnginesOfGrowthArabic: React.FC = () => {
    return (
        <AbsoluteFill>
            ...
            {manifest.scenes.map((scene, index) => {
                ...
                return (
                    ...
                    >
                        <Audio src={staticFile(`engines-of-growth-ar/voiceover/${scene.audio}`)} />
                        <SceneRouter
