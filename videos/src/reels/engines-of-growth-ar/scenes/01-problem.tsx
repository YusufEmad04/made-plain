...
export const ProblemScene: React.FC<{ words: Word[]; total: number }> = ({ words, total }) => {
    const subscriptionAt = wordCue(words, "اشتراك", 34);
    const socialAt = wordCue(words, "مشاركة", subscriptionAt + 18);
    const productAt = wordCue(words, "منتجات", socialAt + 18);
    const pickAt = wordCue(words, "محرك", productAt + 52);
