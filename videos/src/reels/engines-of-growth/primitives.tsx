...
export const BusinessSelector: React.FC<{
    ...
    const frame = useCurrentFrame();
    const cards = [
        { label: "SUBSCRIPTION", brand: "SPOTIFY", rule: "stay", color: engineData.sticky.color, at: subscriptionAt, kind: "card" },
        { label: "SOCIAL APP", brand: "TIKTOK", rule: "share", color: engineData.viral.color, at: socialAt, kind: "nodes" },
        { label: "PRODUCT STORE", brand: "AMAZON", rule: "pay back", color: engineData.paid.color, at: productAt, kind: "box" },
    ];
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g transform="translate(80 360)">
                {cards.map((card, index) => {
                    ...
                    return (
                        <g key={card.label} opacity={enter} transform={`translate(${x} ${lift})`}>
                            ...
                            <text x="142" y="60" textAnchor="middle" fontFamily={fonts.mono} fontSize="24" fontWeight="700" fill={card.color} letterSpacing="2">{card.label}</text>
                            ...
                            <text x="142" y="408" textAnchor="middle" fontFamily={fonts.display} fontSize="50" fontWeight="850" fill={colors.ink}>{card.rule}</text>
                        </g>
                    );
                })}
                <g opacity={fade(frame, pickAt, 14)}>
                    ...
                    <text x="460" y="816" textAnchor="middle" fontFamily={fonts.display} fontSize="58" fontWeight="850" fill={colors.accent}>PICK THE ENGINE</text>
                </g>
            </g>
        </svg>
    );
        ...
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g transform="translate(80 360)">
                {panels.map((panel, index) => {
                    ...
                    return (
                        <g key={panel.kind} opacity={draw} transform={`translate(${x} ${rise(frame, panel.at, 22)})`}>
                            ...
                            <text x="142" y="618" textAnchor="middle" fontFamily={fonts.mono} fontSize="22" fontWeight="600" fill={colors.mute} letterSpacing="3">LIKE</text>
                ...
                <g opacity={fade(frame, testAt, 14)}>
                    ...
                    <text x="460" y="836" textAnchor="middle" fontFamily={fonts.display} fontSize="50" fontWeight="850" fill={colors.accent}>One test per engine.</text>
                </g>
            </g>
        </svg>
    );
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0, opacity: fade(frame, at, 14) }}>
            <g transform="translate(88 335)">
                ...
                <text x="0" y="12" fontFamily={fonts.body} fontSize="42" fontStyle="italic" fill={colors.mute}>customers stay long enough to pay again</text>
                <g transform="translate(55 185)">
                    <PillSvg x={0} y={-120} width={390} color={color} text="NEW CUSTOMERS JOIN" />
                    ...
                    <text x="205" y="305" textAnchor="middle" fontFamily={fonts.display} fontSize="50" fontWeight="800" fill={colors.ink}>ACTIVE</text>
                    <text x="205" y="360" textAnchor="middle" fontFamily={fonts.display} fontSize="50" fontWeight="800" fill={colors.ink}>CUSTOMERS</text>
                    ...
                    <PillSvg x={440} y={430} width={320} color={colors.neg} text="CHURN / CANCELS" opacity={leak} />
                ...
                <InequalitySvg x={0} y={880} left="20 new" right="8 churn" color={lessonColors.success} at={successAt} />
            </g>
        </svg>
    );
};
...
export const RecurringRevenueStack: React.FC<{
    ...
    const userLabel = stageMillion ? "1,000,000 USERS" : stageMrr ? "10 USERS" : "0 USERS";
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g opacity={fade(frame, introAt, 12)}>
                ...
                <text x="540" y="320" textAnchor="middle" fontFamily={fonts.body} fontSize="32" fontStyle="italic" fill={colors.mute}>recurring revenue compounds</text>
                <text x="540" y="358" textAnchor="middle" fontFamily={fonts.mono} fontSize="20" fontWeight="600" fill={colors.mute2} letterSpacing="4">EXAMPLE: SPOTIFY</text>
            </g>
            ...
            <g transform="translate(80 380)" opacity={fade(frame, mrrAt - 6, 12)}>
                ...
                <text x="30" y="50" fontFamily={fonts.mono} fontSize="24" fontWeight="700" fill={colors.mute} letterSpacing="3">USERS</text>
                ...
                <text x="80" y="370" fontFamily={fonts.mono} fontSize="22" fontWeight="700" fill={colors.mute} letterSpacing="2">$10 / month each</text>
            ...
            <g transform="translate(80 830)" opacity={fade(frame, arrAt, 14)}>
                ...
                <text x="460" y="108" textAnchor="middle" fontFamily={fonts.mono} fontSize="22" fontWeight="700" fill={colors.mute} letterSpacing="3">TWELVE MONTHS STACKED</text>
                {arrBricks}
            ...
            <g transform="translate(80 1240)" opacity={fade(frame, churnAt, 14)}>
                ...
                <text x="460" y="86" textAnchor="middle" fontFamily={fonts.display} fontSize="42" fontWeight="850" fill={red}>CHURN ONE = LOSE 12 MONTHS</text>
                <text x="460" y="148" textAnchor="middle" fontFamily={fonts.body} fontSize="28" fontStyle="italic" fill={colors.mute}>every retained user compounds for a full year</text>
                <text x="460" y="190" textAnchor="middle" fontFamily={fonts.mono} fontSize="22" fontWeight="700" fill={colors.mute2} letterSpacing="3">SPOTIFY · NETFLIX LIVE ON THIS</text>
            </g>
        </svg>
    );
};
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0, opacity: fade(frame, at, 12) }}>
            <g transform="translate(80 350)">
                ...
                <text x="0" y="60" fontFamily={fonts.body} fontSize="42" fontStyle="italic" fill={colors.mute}>users bring users</text>
                <PillSvg x={0} y={120} width={650} color={magenta} text="K = NEW USERS EACH USER BRINGS" />
                ...
                <g opacity={fade(frame, redAt, 12)}>
                    ...
                    <text x="460" y="928" textAnchor="middle" fontFamily={fonts.display} fontSize="58" fontWeight="850" fill={red}>K = 0.6, chain fades</text>
                </g>
                <g opacity={fade(frame, at + 72, 12) * (1 - redMode)}>
                    <rect x="0" y="860" width="920" height="104" rx="8" fill={`${green}22`} stroke={green} strokeWidth="4" />
                    <text x="460" y="928" textAnchor="middle" fontFamily={fonts.display} fontSize="58" fontWeight="850" fill={green}>K = 1.3, audience compounds</text>
                </g>
            </g>
        </svg>
    );
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g transform="translate(80 285)" opacity={fade(frame, whyAt, 12)}>
                <text x="460" y="0" textAnchor="middle" fontFamily={fonts.display} fontSize="74" fontWeight="850" fill={colors.accent}>WHY AUDIENCE?</text>
                <g opacity={fade(frame, accessAt, 12)}>
                    <rect x="60" y="55" width="820" height="86" rx="10" fill={`${magenta}18`} stroke={magenta} strokeWidth="4" />
                    <text x="470" y="112" textAnchor="middle" fontFamily={fonts.display} fontSize="46" fontWeight="850" fill={magenta}>sell access to the crowd</text>
                </g>
                <g transform="translate(0 195)">
                    <text x="0" y="0" fontFamily={fonts.mono} fontSize="28" fontWeight="700" fill={magenta} letterSpacing="3">MARKETPLACE</text>
                    ...
                    <text x="205" y="86" textAnchor="middle" fontFamily={fonts.display} fontSize="42" fontWeight="850" fill={colors.ink}>BUYERS</text>
                    <text x="715" y="86" textAnchor="middle" fontFamily={fonts.display} fontSize="42" fontWeight="850" fill={colors.ink}>SELLERS</text>
                    {buyerDots.map((_, i) => {
                        const col = i % 5;
                        const row = Math.floor(i / 5);
                ...
                <g transform="translate(0 660)" opacity={fade(frame, mediaAt, 12)}>
                    <text x="0" y="0" fontFamily={fonts.mono} fontSize="28" fontWeight="700" fill={magenta} letterSpacing="3">MEDIA APP</text>
                    ...
                    <text x="295" y="305" textAnchor="middle" fontFamily={fonts.mono} fontSize="24" fontWeight="700" fill={magenta} letterSpacing="2">VIEWERS / ATTENTION</text>
                    <g transform="translate(660 70)" opacity={fade(frame, sponsorsAt, 12)}>
                        ...
                        <text x="130" y="72" textAnchor="middle" fontFamily={fonts.display} fontSize="46" fontWeight="850" fill={lessonColors.success}>SPONSOR</text>
                        <text x="130" y="126" textAnchor="middle" fontFamily={fonts.mono} fontSize="32" fontWeight="700" fill={lessonColors.success}>PAYS</text>
                    </g>
                ...
                <g opacity={fade(frame, productAt, 14)}>
                    ...
                    <text x="470" y="1148" textAnchor="middle" fontFamily={fonts.display} fontSize="50" fontWeight="850" fill={magenta}>The audience is the product.</text>
                </g>
            </g>
        </svg>
    );
...
export const PaidMachine: React.FC<{
    ...
    const verdictWord = isLoss ? "LOSS" : "SCALE";
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            ...
            <g opacity={fade(frame, at, 12)}>
                ...
                <text x="540" y="325" textAnchor="middle" fontFamily={fonts.body} fontSize="32" fontStyle="italic" fill={colors.mute}>turn money into profitable customers</text>
                <text x="540" y="362" textAnchor="middle" fontFamily={fonts.mono} fontSize="20" fontWeight="600" fill={colors.mute2} letterSpacing="4">EXAMPLE: {brand}</text>
            </g>
            ...
            <g opacity={fade(frame, cacAt, 14)}>
                ...
                <text x="540" y="445" textAnchor="middle" fontFamily={fonts.display} fontSize="40" fontWeight="850" fill={colors.neg}>CAC — cost to win a customer</text>

                {/* SPEND label + coins falling */}
                <text x="180" y="500" fontFamily={fonts.mono} fontSize="22" fontWeight="700" fill={colors.neg} letterSpacing="3" opacity={fade(frame, spendAt, 10)}>SPEND</text>
                {[0, 1, 2, 3].map((i) => {
                ...
                <g transform="translate(880 690)" opacity={fade(frame, customerAt, 12)}>
                    ...
                    <text x="0" y="135" textAnchor="middle" fontFamily={fonts.mono} fontSize="22" fontWeight="700" fill={gold}>1 CUSTOMER</text>
                </g>
                ...
                <g opacity={fade(frame, customerAt + 14, 12)}>
                    ...
                    <text x="230" y="738" textAnchor="middle" fontFamily={fonts.mono} fontSize="20" fontWeight="700" fill={colors.neg} letterSpacing="3">CAC TOTAL</text>
            ...
            <g opacity={fade(frame, ltvAt, 14)}>
                ...
                <text x="540" y="890" textAnchor="middle" fontFamily={fonts.display} fontSize="40" fontWeight="850" fill={lessonColors.success}>LTV — what that customer pays back</text>
...
export const TrapCarousel: React.FC<{
    ...
    const panels = [
        { title: "ADS CANNOT SAVE A LEAK", color: engineData.sticky.color, type: "leak" },
        { title: "ISOLATED USERS ARE NOT A NETWORK", color: engineData.viral.color, type: "network" },
        { title: "VIRAL CANNOT FIX BAD MATH", color: engineData.paid.color, type: "loss" },
    ];
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g transform="translate(80 285)">
                <text x="460" y="0" textAnchor="middle" fontFamily={fonts.display} fontSize="60" fontWeight="850" fill={colors.accent}>WRONG ENGINE, WRONG FIX</text>
                <g opacity={fade(frame, panelEnterAt, 8)} transform={`translate(${(1 - fade(frame, panelEnterAt, 10)) * 34} 0)`}>
                    ...
                    <text x="460" y="215" textAnchor="middle" fontFamily={fonts.mono} fontSize="31" fontWeight="700" fill={panel.color} letterSpacing="3">{panel.title}</text>
    ...
    if (type === "network") {
        return (
            <g transform="translate(105 330)">
                ...
                <text x="365" y="690" textAnchor="middle" fontFamily={fonts.display} fontSize="72" fontWeight="850" fill={colors.neg} opacity={fade(frame, startAt + 52, 10)}>NO CONNECTIONS</text>
            </g>
        );
    }
    if (type === "loss") {
        return (
            <g transform="translate(105 330)">
                ...
                <text x="370" y="150" textAnchor="middle" fontFamily={fonts.mono} fontSize="28" fontWeight="700" fill={colors.neg}>PER SALE</text>
                ...
                <text x="365" y="700" textAnchor="middle" fontFamily={fonts.display} fontSize="54" fontWeight="850" fill={colors.neg} opacity={fade(frame, startAt + 76, 10)}>MORE DEMAND, MORE LOSS</text>
            </g>
        );
    }
    return (
        <g transform="translate(105 300)">
            <g opacity={fade(frame, startAt + 10, 8)}>
                ...
                <text x="105" y="260" textAnchor="middle" fontFamily={fonts.mono} fontSize="30" fontWeight="700" fill={engineData.paid.color}>ADS IN</text>
            </g>
            <defs>
            ...
            <g transform="translate(0 0)">
                ...
                <text x="485" y="350" textAnchor="middle" fontFamily={fonts.display} fontSize="60" fontWeight="850" fill={colors.ink}>BASE</text>
                <g opacity={fade(frame, startAt + 42, 8)}>
                    ...
                    <text x="495" y="735" textAnchor="middle" fontFamily={fonts.display} fontSize="66" fontWeight="850" fill={colors.neg}>CHURN OUT</text>
                </g>
            </g>
        </g>
    );
...
export const DiagnosticPath: React.FC<{
    ...
    const frame = useCurrentFrame();
    const steps = [
        { at: repeatAt, question: "repeat customers?", kind: "sticky" as EngineKind, rule: "NEW > CHURN" },
        { at: networkAt, question: "users make network?", kind: "viral" as EngineKind, rule: "K > 1" },
        { at: paidAt, question: "buy customers?", kind: "paid" as EngineKind, rule: "LTV > CAC" },
    ];
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            <g transform="translate(80 350)">
                <text x="460" y="0" textAnchor="middle" fontFamily={fonts.display} fontSize="78" fontWeight="850" fill={colors.accent}>ASK ONE THING</text>
    ...
    return (
        <svg viewBox="0 0 1080 1920" style={{ position: "absolute", inset: 0 }}>
            ...
            <g opacity={fade(frame, trueAt, 12)}>
                ...
                <text x="540" y="1340" textAnchor="middle" fontFamily={fonts.display} fontSize="54" fontWeight="850" fill={colors.ink}>MAKE YOUR EQUATION TRUE</text>
