    ...
    return (
        <footer className="border-t border-[var(--color-line)] bg-[var(--color-paper)] py-16">
            ...
            <div className="mx-auto mt-12 flex max-w-[1320px] flex-col gap-3 border-t border-[var(--color-line)] px-5 pt-6 text-[13px] text-[var(--color-mute)] sm:flex-row sm:items-center sm:justify-between sm:px-8 lg:px-12">
                <p>© 2026 Made Plain · A product of{" "}
                    <a
            ...
            <div className="mx-auto max-w-[1320px] px-5 pb-4 pt-3 sm:px-8 lg:px-12">
                <p className="text-[12px] text-[var(--color-mute)]/70">
                    All payments and invoices are issued by{" "}
                    <a
                        href="https://www.simplx.tech/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    , the merchant of record for all Made Plain products.
                </p>
            </div>
        </footer>
    );
